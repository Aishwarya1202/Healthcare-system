...
class hospital:
    def __init__(self,root) -> None:
        ...
        doctors_btn=Button(option_frame,text="STAFF",command=self.details_staff,width=22,height=2,font=("times new roman",14,"bold"),bg="light sky blue",fg="white",bd=0, cursor="arrow")
        doctors_btn.grid(row=2,column=0,pady=1)

        info_btn=Button(option_frame,text="BILL",command=self.about_hospital,width=22,height=2,font=("times new roman",14,"bold"),bg="light sky blue",fg="white",bd=0, cursor="arrow")
